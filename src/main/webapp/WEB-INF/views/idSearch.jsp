...
<script type="text/javascript">
	...
	function search(){
		if(document.id_form.name.value==""){
			alert("이름을 입력해주세요.");
			document.id_form.name.focus();
		}else if(document.id_form.phone_num.value==""){
			alert("핸드폰번호를 입력해주세요.");
			document.id_form.phone_num.focus();
		}else{
...
<div class="login-page">
	  	<div class="container">
		      <form class="form-login" id="id_form" name="id_form" action="/idSearch" method="POST">
		        <h2 class="form-login-heading">아이디찾기</h2>
